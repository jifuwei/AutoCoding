package com.autocoding.ac.foundation.error;
...
public class ACErrorMsg {
    ...
    public static ACResponseMsg getDefaultSuccessResponseMsg() {
        ACResponseMsg acResponseMsg = new ACResponseMsg();
        acResponseMsg.errcode = ACErrorMsg.CALL_SUCCESS.errcode;
        acResponseMsg.errmsg = ACErrorMsg.CALL_SUCCESS.errmsg;
        return acResponseMsg;
    }
}
